...
# curl -d '{"url":"https://www.finn.no/realestate/homes/search.html?location=0.20061&page=4"}' -H "Content-Type: application/json" -X POST https://adcrawler-e2ofq27tbq-ew.a.run.app
